...
<body class="page-template page-template-Search_Form page-template-saag_search page-template-Search_Formsaag_search-php page page-id-106 page-child parent-pageid-71 has-header-image page-two-column colors-light">
	<div id="wrapper">
		<article id="main" class="clearfix">
			<section id="main_content">
				...
				<section id="sa_search" style="display:block">
					<p class="pb20">ソリマチソフトに詳しく、また、経営コンサルタントとしても優秀な税理士、公認会計士、社会保険労務士、司法書士、中小企業診断士、弁護士等の全国組織です。経営コンサル・ＯＡ指導で相談をご希望の方は、お近くのパートナー先生を検索してみてはいかがでしょうか？</p>
					<div class="hBlock_saag"></div>
					...
					<section id="ad_search" class="clearfix">
						...
						<div class="select">
							<div class="check_map">
								<ul class="title_saag seihin mb20">
									<li>■　取扱製品</li>
									<li><span>選択しない場合は、<br />すべての製品で検索します。</span></li>
								</ul>
								<div id="check_pro" class="listChkBox"></div>
								<ul class="title_saag sigyo mb20">
									<li>■　資格を選択</li>
									<li><span>選択しない場合は、<br />すべての資格で検索します。</span></li>
								</ul>
								<div id="check_sp" class="listChkBox"></div>
							</div>

							<div class="map_selected">
								<div class="select_area">
									<p class="saag_bl_area">北海道</p>
								...
								<p class="center"><input type="button" name="submit_research" id="ok" value="上記の条件で再検索する" style="width:98%; font-size:15px; display:none; background-color:#93000b !important; background-image:none !important;" /></p>
							</div>
							<div class="map">
					...
					<p class="center img">
						<a href="/partner/saag/req/" class="iconSo" target="_blank">
							<img src="/assets/images/uploads/profile/images_layout/banner_01.jpg" width="859" height="180" class="hide_sp">
							<img src="/assets/images/uploads/profile/images_layout/banner_01_sp.jpg" width="859" height="180" class="hide_pc">
						</a>
					</p>
				</section>
...
<script type='text/javascript' src='/assets/js/search_form/saag_search.js'></script>