	...
	<div class="containers clear">
		...
		<div class="content-right">
			<section id="row1" class="clear">
				<div>
					<h2 class="title-parent-sosp">メールマガジン バックナンバー</h2>
				</div>
				...
				<div class="row">
					<table border="0" cellspacing="1" cellpadding="0">
						...
						<tr>
							<td nowrap style="padding:0px 5px;"><a href="javascript:PageJump('mag_partner')"><img src="/assets/images/sosp/btn_mag_p1.gif" onMouseover="this.src='/assets/images/sosp/btn_mag_p2.gif'" onMouseout="this.src='/assets/images/sosp/btn_mag_p1.gif'" border="0" alt=""></a></td>
						...
						<tr>
							<td nowrap style="padding:0px 5px;"><a href="javascript:PageJump('mag_user_vn')"><img src="/assets/images/sosp/btn_mag_u1.gif" onMouseover="this.src='/assets/images/sosp/btn_mag_u2.gif'" onMouseout="this.src='/assets/images/sosp/btn_mag_u1.gif'" border="0" alt=""></a></td>
							<td nowrap style="font-size:14px; line-height:20px; font-family:'MS UI Gothic','ＭＳ Ｐゴシック',Osaka,Sans-serif; ">
		...
		<FORM action="<?= htmlspecialchars("https://info.sorimachi.co.jp/mag/"); ?>" name="mag_partner" method="post" target="_blank">
			<input type="hidden" name="mag_user" value="<?= base64_encode(mt_rand(10, 20) . @$_SESSION["SOSP-ID"] . mt_rand(10, 20)) ?>">
			<input type="hidden" name="mag_category" value="partner">
			<input type="hidden" name="mag_child" value="sosp">
		</FORM>
