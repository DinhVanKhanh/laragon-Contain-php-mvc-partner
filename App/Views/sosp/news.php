...
<div id="partner-container">
	<div class="containers clear">
		...
		<div class="content-right">
			<div>
				<h2 class="title-parent-sosp">お知らせ</h2>
			</div>
			<div>こちらに事務局からのお知らせを随時配信してまいります。</div><br>
			<?php IncludeNewsreleaseBody(212, 1000, $typePage) ?>
		</div>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2018/" name="kakutei2018" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2017/" name="kakutei2017" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2016/" name="kakutei2016" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2015/" name="kakutei2015" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2014/" name="kakutei2014" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2013/" name="kakutei2013" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2012/" name="kakutei2012" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2011/" name="kakutei2011" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2010/" name="kakutei2010" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2009/" name="kakutei2009" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
		...
		<FORM action="<?= $SORIMACHI_HOME_SSL ?>usersupport/products_support/softdownload/kakutei2008/" name="kakutei2008" method="post"><input type="hidden" name="kakutei" value="SOSP"></FORM>
