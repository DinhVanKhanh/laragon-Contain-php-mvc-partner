   ...
   function wb(a) {
    ...
    function rb(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            f = a.aanFeatures,
            g = '<input id="mysearch" type="search" class="' + b.sFilterInput + '"/>',
            j = d.sSearch,
            j = j.match(/_INPUT_/) ? j.replace("_INPUT_", g) : j + g,
            b = h("<div/>", {
                id: !f.f ? c + "_filter" : null,
                "class": b.sFilter
            }).append(h("<label/>").append(j).append("<button class='btnReset'>解除</button>")),
            f = function() {
                var b = !this.value ?
                    "" : this.value;
                b != e.sSearch && (ga(a, {
            ...
            i = h("#mysearch", b).val(e.sSearch).attr("placeholder", d.sSearchPlaceholder).on("search.DT paste.DT cut.DT", g ? Qa(f, g) : f).on("keypress.DT", function(a) {
                if (13 == a.keyCode) return !1 // keyup.DT search.DT input.DT paste.DT cut.DT
    ...
    m.defaults = {
        ...
        oLanguage: {
            ...
            sSearch: "<button class='btnSearch'>絞り込み</button>",
            sSearchPlaceholder: "",
            sUrl: "",
            sZeroRecords: "検索結果が見つかりませんでした。"
        },
